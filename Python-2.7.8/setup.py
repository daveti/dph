...
class PyBuildExt(build_ext):
	...
	# daveti: debug
	print('daveti: ssl_incs [%s]' %(ssl_incs))
	...
	# daveti: debug
	print('daveti: ssl_libs [%s]' %(ssl_libs))
	# daveti: hack
	ssl_libs.append('/usr/local/opt/openssl/lib')
	print('daveti: ssl_libs [%s]' %(ssl_libs))
...
##         self.extensions.append(ext)
	...
	# daveti: hack for MacOS Yosemite
